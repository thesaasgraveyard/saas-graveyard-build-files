...
> **Before you trust any of this:** these tools are shared as-is, with no support and no warranty. **Credentials, live URLs, PINs, and employee names have been removed and replaced with `PASTE_YOUR_...` / `YOUR_..._HERE` placeholders** — you must fill in your own before anything will run. Costs, links, and third-party services may have changed since the articles were written. Read the code before running it in your own business (at your own risk).
...
**Prompts that worked**
- `I have an optisigns subscirption which I use to project static images or short videos on to a Roku TV. This costs $20 per month. I want you to create an app or another method for me to project  static images or short videos on to a Roku TV. Take your time and don't make mistakes.`
